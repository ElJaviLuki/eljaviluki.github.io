        ...
        "long": {
            ...
            "caseStudy": {
                ...
                "content": [
                    {
                        "type": "paragraph",
                        "content": "A prime example of a success story is the custom ERP built for Ortoprodent. This dental lab is renowned for the quality of its prosthetics and the skill of its team. However, like many specialized businesses, their administrative management posed significant challenges, draining valuable time and energy. Anticipating that off-the-shelf software would be overly complex for their specific needs, I opted for a pragmatic, built-from-scratch approach. The priority was an exceptionally user-friendly experience (minimal cognitive load), featuring highly streamlined workflows and a clean interface. The result? A tool that doesn't just organize, but actually smooths out management friction, allowing the team to dedicate all their talent to what they do best: crafting outstanding prosthetic work."
                    },
                    {
                        "type": "media",
